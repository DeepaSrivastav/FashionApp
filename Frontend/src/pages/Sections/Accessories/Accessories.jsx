...
const Accessories = () => {
    ...
    const featureImages = [
        '/src/assets/feature-image11.jpg',
        '/src/assets/feature-image12.webp',
        '/src/assets/feature-image13.jpeg'
    ]
    ...
    const filteredProducts = products.filter(product =>  product.category.includes("footwear"))
    ...
    return(
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-row flex-wrap flex-1 gap-10 self-stretch m-20">
                {
